...
pub const RENDEZVOUS_SERVERS: &[&str] = &["171.80.4.191"];
pub const RS_PUB_KEY: &str = "OeVuKk5nlHiXp+APNn0Y3pC1Iwpwn44JGqrQCsWqmBw=";

pub const RENDEZVOUS_PORT: i32 = 6667;
pub const RELAY_PORT: i32 = 6668;
pub const WS_RENDEZVOUS_PORT: i32 = 6669;
pub const WS_RELAY_PORT: i32 = 6670;
